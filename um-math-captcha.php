...
function um_math_load_plugin_textdomain() {
  load_plugin_textdomain( 'um-math-captcha', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
add_action('plugins_loaded', 'um_math_load_plugin_textdomain', 3); ?>
